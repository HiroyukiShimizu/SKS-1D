...
plot \
9.68 w l lt 0 lc rgb "dark-gray" lw 6 notitle, \
2.65 w l lt 0 lc rgb "dark-gray" lw 6 notitle, \
7.78 w l lt 0 lc rgb "dark-gray" lw 6 notitle, \
'front_L.dat' using 1:14 w l lt 1 lc rgb "red" lw 6 ti "Suspended load", \
'front_H.dat' using 1:4 w l lt 1 lc rgb "blue" lw 6 ti "Bed load", \
