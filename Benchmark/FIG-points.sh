...
#set key
#plot \
#1.265 w l lt 1 lc rgb "red" lw 10 ti "Exp. (time-ave.)"
...
unset title
set key
set arrow 1 nohead from 0.519,1.35378 to 4.519,1.35378 lt 1 lc rgb "dark-grey" lw 30
plot \
'point_1_L.dat' using 1:2 w l lt 1 lc rgb "red" lw 6 ti "Numerical"

#func(x) w l lt 1 lc rgb "dark-grey" lw 20 ti "Exp. (time-dep.)", \
...
unset title
set key
set arrow 1 nohead from 1.936,1.2857 to 5.936,1.2857 lt 1 lc rgb "dark-grey" lw 30
plot \
...
#set key bottom right
#plot \
#'point_1_H.dat' using 1:6 w l lt 1 lc rgb "blue" lw 6 ti "Numerical"

set terminal postscript eps color enhanced "Arial" 30
set output "h_H_profile=1.eps"
set xrange [0:4]
set yrange [0:0.06]
set ytics 0,0.01,0.06
set xlabel '{/=35 Time,  {/Arial-Italic t} [s]}'
set ylabel '{/=35 Thickness,  {/Arial-Italic h}_H [m]}'
unset title
set key top right
plot \
0.015 w l lt 1 lc rgb "blue" lw 10 ti "{/Arial-Italic h}_{H1}(time ave.)", \
0.005 w l lt 0 lc rgb "blue" lw 5 ti "{/Arial-Italic h}_{H1}(mim)", \
0.02 w l lt 0 lc rgb "blue" lw 5 ti "{/Arial-Italic h}_{H1}(max)"
...
unset title
set key top right
set arrow 1 nohead from 0.959,0.01462875 to 4.519,0.01462875 lt 1 lc rgb "dark-grey" lw 30
plot \
...
unset title
set key top right
set arrow 1 nohead from 2.636,0.007941176 to 5.936,0.007941176 lt 1 lc rgb "dark-grey" lw 30
plot \
