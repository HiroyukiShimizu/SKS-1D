...
set arrow 1 from 9.68,0 to 9.68,6 nohead lt 0 lc rgb "dark-gray" lw 10
set arrow 2 from 2.65,0 to 2.65,6 nohead lt 0 lc rgb "dark-gray" lw 10
set arrow 3 from 7.78,0 to 7.78,6 nohead lt 0 lc rgb "dark-gray" lw 10
set key
plot \
